# world-renderworld-split Specification

## Purpose
TBD - created by archiving change split-render-context-world-renderworld. Update Purpose after archive.
## Requirements
...
Workspace SHALL 保持可编译，现有 demo 的可运行行为 SHALL 不因 World / RenderWorld 拆分发生功能回归。
