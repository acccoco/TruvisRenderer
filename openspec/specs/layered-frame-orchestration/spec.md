...
定义 BaseApp、RenderBackend 与 App/Plugin 之间的分层帧生命周期边界，约束各层只通过公开 lifecycle 方法和 typed Ctx 协作。

## Requirements

### Requirement: BaseApp drives RenderBackend lifecycle without field access
...
### Requirement: BaseApp run_frame follows strict phase ordering
...
### Requirement: App composes PluginRenderCtx from RenderBackend Ctx
...
### Requirement: Resize is driven through App and BaseApp with RenderBackend Ctx
