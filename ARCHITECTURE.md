...
flowchart TB
    ...
    L2["L2 truvis-render-foundation<br/>GpuStore、BindlessManager、RenderSceneView、FrameCounter、CmdAllocator、FifBuffers（帧基础设施资源）"]
...
- `app/app-kit`：app 层公共组件，不承载具体 app state。
