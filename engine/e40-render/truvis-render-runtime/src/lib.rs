//! 被 `RenderLoop` 驱动的渲染运行时集成层。
//!
//! 本 crate 持有 `Gfx` root owner、CPU `GameWorld`、GPU resource/binding/timing owner 和 runtime 私有
