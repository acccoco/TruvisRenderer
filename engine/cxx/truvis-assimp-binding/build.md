...
```
// truvis-assimp-binding/build.rs 生成 Assimp C API 的 FFI 绑定到 build/bindings/{TARGET}/cxx/truvis-assimp-binding/，
// 并声明链接 truvixx-assimp-capi。
...
- `truvis-assimp-binding/build.rs` 负责从 `mods/truvixx-assimp/include/TruvixxAssimp/c_api/module.h` 生成 `build/bindings/{TARGET}/cxx/truvis-assimp-binding/_ffi_bindings.rs`
