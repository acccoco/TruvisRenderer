...
ResType TRUVIXX_INTERFACE_API truvixx_scene_is_loaded(TruvixxSceneHandle scene);
...
TRUVIXX_INTERFACE_API const char* truvixx_scene_last_error(TruvixxSceneHandle scene);
